...
public class ClickHouseSinkFunction extends RichSinkFunction<RowData> {
    ...
    private final JdbcDmlOptions jdbcReadOptions;
    ...
    public ClickHouseSinkFunction(JdbcConnectionOptions jdbcOptions,JdbcDmlOptions jdbcReadOptions, SerializationSchema<RowData> serializationSchema) {
        this.jdbcReadOptions = jdbcReadOptions;
    ...
    public void invoke(RowData value, Context context) throws Exception {
        ...
        stmt.write().table(jdbcReadOptions.getTableName()).data(new ByteArrayInputStream(serialize), ClickHouseFormat.CSV)
